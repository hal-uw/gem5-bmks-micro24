...
__device__ __constant__ int senone_size = 512;
...
int main(int argc, char *argv[]) {
  ...
  hipEventRecord(eStart, 0);
  m5_getKernelArg(reinterpret_cast<uintptr_t>(dev_feat_vect), reinterpret_cast<uintptr_t>(dev_means_vect), reinterpret_cast<uintptr_t>(dev_precs_vect), 0, 3, 1);
  m5_getKernelArg(reinterpret_cast<uintptr_t>(dev_weight_vect), reinterpret_cast<uintptr_t>(dev_factor_vect), reinterpret_cast<uintptr_t>(dev_score_vect), 48, 3, 1);
  hipLaunchKernelGGL(HIP_KERNEL_NAME(computeScore), dim3(grid), dim3(block), 0, 0, dev_feat_vect, dev_means_vect,
