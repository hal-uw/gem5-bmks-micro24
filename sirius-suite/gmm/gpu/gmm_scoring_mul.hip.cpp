...
int main(int argc, char *argv[]) {
  ...
  for (int i=0; i < GPU_N; i++) {
    ...
    hipLaunchKernelGGL(HIP_KERNEL_NAME(computeScore), dim3(grid), dim3(block), 0, 0, feature_vect, means_vect2,
                                     precs_vect2, weight_vect2,
                                     factor_vect2, score_vect, start);
