...
hipStreamCreateWithFlags(&hip_stream, 0x01, -1);
  ...
  hipLaunchKernelGGL(hip_initialize_variables, dim3(Dg), dim3(Db), 0, hip_stream, nelr, variables);
...
hipStreamCreateWithFlags(&hip_stream, 0x01, -1);
  ...
  hipLaunchKernelGGL(hip_compute_step_factor, dim3(Dg), dim3(Db), 0, hip_stream, nelr, variables, areas, step_factors);         
...
hipStreamCreateWithFlags(&hip_stream, 0x01, -1);
  ...
  hipLaunchKernelGGL(hip_compute_flux, dim3(Dg), dim3(Db), 0, hip_stream, nelr, elements_surrounding_elements, normals, variables, fluxes);
...
hipStreamCreateWithFlags(&hip_stream, 0x01, -1);
  ...
  hipLaunchKernelGGL(hip_time_step, dim3(Dg), dim3(Db), 0, hip_stream, j, nelr, old_variables, variables, step_factors, fluxes);
