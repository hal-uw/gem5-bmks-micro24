...
int main(int argc, char* argv[])
{
   ...
   * Execute kernel
   */
  m5_getKernelArg(reinterpret_cast<uintptr_t>(&locations[0]), reinterpret_cast<uintptr_t>(distances), 0, 12, 3, 1);
  hipLaunchKernelGGL(euclid, dim3(gridDim), dim3(threadsPerBlock ), 0, 0, &locations[0] /*d_locations*/ ,/*d_*/distances,numRecords,lat,lng);
  hipDeviceSynchronize();
