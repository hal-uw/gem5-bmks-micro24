...
#include "kernel_fin_2.h"
#include "kernel_ecc_2.h"
#include "kernel_cam_2.h"
#include "kernel_2.h"
#include "embedded_fehlberg_7_8_2.h"
#include "solver_2.h"
#include "timer.h"
...
int work_2(	int xmax,
  ...
  for(i=0; i<workload; i++){
    ...
    read("/nobackup/sinclair/gem5-resources/src/gpu/rodinia/data/myocyte/y.txt",
	 &y[pointer],
	 91,
	 1,
	 0);
  ...
  for(i=0; i<workload; i++){
    ...
    read("/nobackup/sinclair/gem5-resources/src/gpu/rodinia/data/myocyte/params.txt",
	 &params[pointer],
	 18,
	 1,
	 0);
  ...
  printf("%.12f s, %.12f percent : SETUP VARIABLES\n",
	 (float) (time1-time0) / 1000000, (float) (time1-time0) / (float) (time6-time0) * 100);
  printf("%.12f s, %.12f percent : ALLOCATE CPU MEMORY AND GPU MEMORY\n",
	 (float) (time2-time1) / 1000000, (float) (time2-time1) / (float) (time6-time0) * 100);
  printf("%.12f s, %.12f percent : READ DATA FROM FILES, COPY TO GPU MEMORY\n",
	 (float) (time3-time2) / 1000000, (float) (time3-time2) / (float) (time6-time0) * 100);
  printf("%.12f s, %.12f percent : RUN GPU KERNEL\n",
	 (float) (time4-time3) / 1000000, (float) (time4-time3) / (float) (time6-time0) * 100);
  printf("%.12f s, %.12f percent : COPY GPU DATA TO CPU MEMORY\n",
	 (float) (time5-time4) / 1000000, (float) (time5-time4) / (float) (time6-time0) * 100);
  printf("%.12f s, %.12f percent : FREE MEMORY\n",
