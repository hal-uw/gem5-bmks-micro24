...
void hydroInit(
  ...
  hipStreamCreateWithFlags(&hip_stream, 0x01, -1);	
    ...
    m5_getKernelArg(reinterpret_cast<uintptr_t>(mapspkeyD), reinterpret_cast<uintptr_t>(mapspvalD), reinterpret_cast<uintptr_t>(mappsfirstD), 0b110000 , 3, kernelCount);
      m5_getKernelArg(reinterpret_cast<uintptr_t>(mapssnextD), 0, 0, 0b11 , 1, kernelCount++);
    hipLaunchKernelGGL(gpuInvMap, dim3(gridSize), dim3(chunkSize), 0, hip_stream, mapspkeyD, mapspvalD,
...
void hydroDoCycle(
  ...
  hipStreamCreateWithFlags(&hip_stream, 0x01, -1);	
    ...
    m5_getKernelArg(0, 0, 0, 0 , 0, kernelCount++);
    hipLaunchKernelGGL(gpuMain1, dim3(gridSizeP), dim3(chunkSize), 0, hip_stream, 0);
    hipHccModuleRingDoorbell(hip_stream);
    hipStreamSynchronize(hip_stream);
    m5_dump_reset_stats(0, 0);
    hipDeviceSynchronize();
    m5_getKernelArg(0, 0, 0, 0 , 0, kernelCount++);
    hipLaunchKernelGGL(gpuMain2, dim3(gridSizeS), dim3(chunkSize), 0, hip_stream, 0);
    hipHccModuleRingDoorbell(hip_stream);
    hipStreamSynchronize(hip_stream);
    m5_dump_reset_stats(0, 0);
    hipDeviceSynchronize();
    meshCheckBadSides();
    m5_getKernelArg(0, 0, 0, 0 , 0, kernelCount++);
    hipLaunchKernelGGL(gpuMain3, dim3(gridSizeP), dim3(chunkSize), 0, hip_stream, 0);
    hipHccModuleRingDoorbell(hip_stream);
    hipStreamSynchronize(hip_stream);
    m5_dump_reset_stats(0, 0);
    hipDeviceSynchronize();
    ...
    m5_getKernelArg(0, 0, 0, 0 , 0, kernelCount++);
    hipLaunchKernelGGL(gpuMain4, dim3(gridSizeS), dim3(chunkSize), 0, hip_stream, 0);
    hipHccModuleRingDoorbell(hip_stream);
    hipStreamSynchronize(hip_stream);
    m5_dump_reset_stats(0, 0);
    hipDeviceSynchronize();
    m5_getKernelArg(0, 0, 0, 0 , 0, kernelCount++);
    hipLaunchKernelGGL(gpuMain5, dim3(gridSizeZ), dim3(chunkSize), 0, hip_stream, 0);
    hipHccModuleRingDoorbell(hip_stream);
    hipStreamSynchronize(hip_stream);
    m5_dump_reset_stats(0, 0);
    hipDeviceSynchronize();
